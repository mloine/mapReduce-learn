 ...
 */
public class SelectIdOneDriver extends Configured implements Tool {

    public static void main(String[] args) {
        try {
            System.exit(ToolRunner.run(new SelectIdOneDriver(),args));
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "SelectIdMR-t");
        ...
        //map class
        job.setMapperClass(SelectIdOneMapper.class);
...
//        job.setCombinerClass(SelectIdReduce.class);
        ...
        //reduce class
        job.setReducerClass(SelectIdOneReduce.class);
